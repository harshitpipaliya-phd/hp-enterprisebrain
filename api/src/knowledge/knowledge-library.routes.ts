...
export function knowledgeLibraryRoutes(): Router {
  const router = Router();
  ...
  router.get('/:tenantId/most-reused', async (req: AuthenticatedRequest, res: Response) => {
  ...
  router.post('/:tenantId/:id/reuse', async (req: AuthenticatedRequest, res: Response) => {
