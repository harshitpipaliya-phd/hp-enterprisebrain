 ...
 */
import {
  OrganizationRepository, DepartmentRepository, PersonRepository, CapabilityRepository,
  ExecutorRepository, PolicyRepository, SignalRepository,
...
import {
  ReasoningStepRepository, RecommendationRepository, DecisionRepository,
  EsoExecutionRepository, OutcomeRepository, LearningRepository, MentalModelRepository,
  CaseRepository, HypothesisRepository, EvidenceRepository,
} from '@hpbrain/database';
