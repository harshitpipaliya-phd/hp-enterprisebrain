...
export function kasbaRoutes(): Router {
  const router = Router();
  ...
  router.get('/tasks/:tenantId/capability/:capabilityId', async (req: AuthenticatedRequest, res: Response) => {
    return res.json(await tasks.listForCapability(req.params.tenantId, req.params.capabilityId));
  });

  router.post('/proficiency', async (req: AuthenticatedRequest, res: Response) => {
  ...
  router.get('/proficiency/:tenantId/assignment/:assignmentId/history', async (req: AuthenticatedRequest, res: Response) => {
   ...
   */
  router.get('/proficiency/:tenantId/assignment/:assignmentId/trend', async (req: AuthenticatedRequest, res: Response) => {
  ...
  router.get('/assessment/:tenantId/assignment/:assignmentId/:capabilityId', async (req: AuthenticatedRequest, res: Response) => {
   ...
   */
  router.get('/heatmap/:tenantId', async (req: AuthenticatedRequest, res: Response) => {
