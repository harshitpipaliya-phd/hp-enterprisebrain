...
async function getSignalIdsWithRecommendations(tenantId) {
...
export function reasoningEngineRoutes() {
     ...
     */
    router.get('/:tenantId/early-warnings', async (req, res) => {
        const tenantId = req.params.tenantId;
     ...
     */
    router.get('/:tenantId/student/:studentPersonId/risk-indicators', async (req, res) => {
