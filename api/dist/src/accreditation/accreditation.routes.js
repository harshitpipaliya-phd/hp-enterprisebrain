...
export function accreditationRoutes() {
    const router = Router();
    ...
    router.get('/frameworks/:tenantId', async (req, res) => {
    ...
    router.get('/criteria/:tenantId/framework/:frameworkId', async (req, res) => {
    ...
    router.post('/criteria/:tenantId/:id/evidence', async (req, res) => {
    ...
    router.patch('/criteria/:tenantId/:id/status', async (req, res) => {
