...
export function conversationRoutes(repo = defaultConversationRepo) {
    const router = Router();
    ...
    router.post('/sessions/:tenantId/:id/messages', async (req, res) => {
    ...
    router.patch('/sessions/:tenantId/:id/pin', async (req, res) => {
    ...
    router.patch('/sessions/:tenantId/:id/rename', async (req, res) => {
    ...
    router.delete('/sessions/:tenantId/:id', async (req, res) => {
    ...
    router.get('/prompt-templates/:tenantId', async (req, res) => {
