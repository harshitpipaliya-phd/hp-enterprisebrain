...
function mockProficiency(assignmentId, overrides = {}) {
...
function mockAssignment(id, capabilityId, personId) {
...
function mockPerson(id, departmentId) {
    return { id, tenantId: 't1', departmentId };
}
...
test('computeCapabilityHeatmap ignores non-person target types', () => {
    ...
    const assignments = [{ id: 'a1', tenantId: 't1', capabilityId: 'cap1', targetType: 'department', targetId: 'dept1', assignedBy: 'u1', assignedDate: new Date().toISOString(), status: 'active' }];
