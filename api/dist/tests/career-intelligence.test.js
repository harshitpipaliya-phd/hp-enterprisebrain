...
function mockProficiency(overrides = {}) {
    return {
...
test('computeCareerReadiness scores 1.0 when every requirement is met', () => {
    const requirements = [{ occupationId: 'o1', capabilityId: 'c1', requiredLevel: 3 }];
...
test('computeCareerReadiness flags a real gap when assessed level is below required', () => {
    const requirements = [{ occupationId: 'o1', capabilityId: 'c1', requiredLevel: 4 }];
